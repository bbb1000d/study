...
- **Document vault** – upload classroom notes or handouts; StudyMate revisits each excerpt twice before replying.
...
- `index.html` – minimal layout with authentication, profile, insights, upload, coaching, and assessment sections.
- `styles.css` – calming palette with soft glassmorphism touches for focus.
- `main.js` – account-aware fetch helpers that wire the UI to the FastAPI endpoints.
